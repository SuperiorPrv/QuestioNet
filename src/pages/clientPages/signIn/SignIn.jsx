...
const SignIn = () => {
  return (
    <>
    <Box sx={{ background:"linear-gradient(to right , #A2D2FF , #CDB4DB )",maxWidth:"1920px",m:"auto",height:"100vh"}}>
     <Box>
...
<Box>
  <Box sx={{width:"450px",borderRadius:"40px",backgroundColor:"#FFFFFF40",marginTop:"50px",marginLeft:"150px",p:"50px"}}>
   ...
   <Typography><Link style={{textDecoration:"none",display:"block",textAlign:"center",fontSize:"24px",color:"#0073FF",marginTop:"29px",fontFamily:""}}>Forgot password?</Link></Typography> 
    ...
    <Typography sx={{textAlign:"center",fontSize:"26px",color:"rgba(69, 103, 137, 1)",marginTop:"45px"}}>Hasn’t any account?  <Link style={{textDecoration:"none",color:"#0073FF"}}>Sign Up</Link></Typography>
  </Box>
</Box>
<Box>
